...
!function webpackUniversalModuleDefinition(root, factory) {
    ...
    , function(module, exports, __webpack_require__) {
        ...
        function isValidDate(dateParts, currentResult, opts) {
            if (!isFinite(dateParts.rawday) || "29" == dateParts.day && !isFinite(dateParts.rawyear) || new Date(dateParts.date.getFullYear(),isFinite(dateParts.rawmonth) ? dateParts.month : dateParts.date.getMonth() + 1,0).getDate() >= dateParts.day)
                return currentResult;
            if ("29" == dateParts.day) {
            ...
            if (opts.min) {
                if (dateParts.rawyear) {
                    ...
                    if (rawYear < minYear) {
                        ...
                        1 === rawYear.length && minYear <= rawYear <= maxYear && !0 !== fromCheckval)
